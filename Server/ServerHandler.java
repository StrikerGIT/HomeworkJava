package GeekCloud.Server;

import GeekCloud.Common.FileSender;
import GeekCloud.Common.File_State;
import GeekCloud.Common.State;
...
//                // отправляем файл
                FileSender.sendFile(Paths.get(stringfilename), ctx.channel(), future -> {
                    if (!future.isSuccess()) {
