        ...
        if (currentState == State.WAIT_FILE) { // ловим инфо по файлу
            ...
            if (currentFileState == File_State.NAME) {
                if (buf.readableBytes() >= nextLength) {
                    ...
                    System.out.println("Получено имя файла - dl_" + new String(fileName,"UTF-8"));
                    out = new BufferedOutputStream(new FileOutputStream("dl_" + new String(fileName)));
