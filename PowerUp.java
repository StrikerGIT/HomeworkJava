...
public class PowerUp implements Poolable {
    ...
    public void moveToHero(Vector2 positionHero) {
        //попробовал поменять направление бонуса в сторону героя, но что-то пошло не так...
        velocity.set((positionHero.x - velocity.x)/5, (positionHero.y - velocity.y)/5);
    }
